    ...
    <main
      ...
      <div class="flex flex-col gap-y-24">
        ...
        <div
          ...
          <div class="flex items-center justify-start" v-motion="'joinHeaderTextMotion1'"
            :initial="headerTextMotion.initial" :leave="headerTextMotion.initial" :enter="headerTextMotion.enter">
            Get
            <div class="bg-primary rounded-full pl-2 lg:pl-4 flex ml-4 lg:ml-8 relative">
              <img src="/common/icons/female.png" alt="Female Memoji Image" class="w-12 lg:w-16 xl:w-20"
                v-motion="'joinHeaderTextImageMotion2'" :initial="headerTextImageMotion2.initial"
                :leave="headerTextImageMotion2.initial" :enter="headerTextImageMotion2.enter" />
              <span class="rounded-full bg-secondary flex-grow-0 ml-1 lg:ml-2 px-2"
                v-motion="'joinHeaderTextImageMotion1'" :initial="headerTextImageMotion.initial"
                :leave="headerTextImageMotion.initial" :enter="headerTextImageMotion.enter">
                <img src="/common/icons/male.png" class="-mb-4 w-12 lg:w-16 xl:w-20" alt="Male Memoji Image" />
              </span>
            </div>
          </div>
          <div class="flex justify-start items-center" v-motion="'joinHeaderTextMotion1'"
            :initial="headerTextMotion2.initial" :leave="headerTextMotion2.initial" :enter="headerTextMotion2.enter">
            Notified</div>
          <div class="flex justify-start items-center" v-motion="'joinHeaderTextMotion1'"
            :initial="headerTextMotion3.initial" :leave="headerTextMotion3.initial" :enter="headerTextMotion3.enter">
            When We</div>
          <div class="flex justify-start items-center" v-motion="'joinHeaderTextMotion1'"
            :initial="headerTextMotion4.initial" :leave="headerTextMotion4.initial" :enter="headerTextMotion4.enter">
            <span>Launch</span>
      ...
      <div
        ...
        v-motion="'joinAppFormMotion1'" :initial="appFormMotion.initial" :leave="appFormMotion.initial"
        ...
        <div
          ...
          <form @submit.prevent="submit()" @keydown.enter.prevent="submit()" class="w-full grid gap-y-16 lg:gap-y-20">
            <input type="text"
            ...
            <button type="submit" value="Get Notified"
