<template>
  <section class="bg-white min-h-screen text-center h-[400vh] py-12 lg:py-0" ref="targetSection">
    <div class="container flex flex-col items-center justify-center top-0 sticky min-h-screen overflow-hidden">
      <div
        class="text-sm lg:text-lg text-primary font-gilmer uppercase border-2 border-[#e3e3e3] rounded-full tracking-widest px-4 lg:px-6 py-5 leading-none">
      ...
      <div class="mt-4 lg:mt-10 mb-0 lg:mb-16">
        <NuxtLink :href="activeFeature?.action" :target="activeFeature?.actionType === 'internal' ? '' : '__blank'"
          ...
          class="border-2 p-4 lg:p-5 lg:rounded-[20px] border-[#e3e3e3] text-black lg:text-lg font-semibold leading-none flex items-center transition duration-200 hover:border-primary hover:border-opacity-40">
